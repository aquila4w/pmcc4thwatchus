            ...
            <div className="lg:col-span-2 space-y-6">
              <Card className="bg-white/5 border-white/10 p-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* Embedded Map */}
                  {(eventData.event.address || eventData.event.location) && (
                    <div className="mt-2">
                      ...
                      <a
                        href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(eventData.event.address || eventData.event.location)}`}
                        target="_blank"
