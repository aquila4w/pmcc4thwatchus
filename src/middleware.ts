...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "img-src 'self' data: blob: https://api.qrserver.com https://images.unsplash.com https://source.unsplash.com https://*.r2.cloudflarestorage.com https://images.pmcc4thwatch.us",
      "font-src 'self'",
